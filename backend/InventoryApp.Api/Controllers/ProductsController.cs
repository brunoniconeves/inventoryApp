...
public class ProductsController : ControllerBase
{
    ...
    [HttpPost("{id}/stock")]
    public async Task<ActionResult<ProductDto>> AddStock(int id, UpdateStockDto stockDto)
    {
        try
        {
            var product = await _productService.AddStockAsync(id, stockDto);
            if (product == null)
            {
                return NotFound();
            }
    ...
    [HttpDelete("{id}/stock")]
    public async Task<ActionResult<ProductDto>> RemoveStock(int id, UpdateStockDto stockDto)
    {
        try
        {
            var product = await _productService.RemoveStockAsync(id, stockDto);
            if (product == null)
            {
                return NotFound();
            }
